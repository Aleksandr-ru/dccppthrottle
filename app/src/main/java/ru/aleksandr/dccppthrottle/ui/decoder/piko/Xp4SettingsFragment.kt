...
class Xp4SettingsFragment : DecoderFragment() {
    ...
    companion object {
        fun newInstance() = Xp4SettingsFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tabTitles = resources.getStringArray(R.array.xp4_conf_tabs)
    ...
    private inner class SlidePagerAdapter(fragment: Fragment): FragmentStateAdapter(fragment) {
        override fun getItemCount(): Int = resources.getStringArray(R.array.xp4_conf_tabs).size

        override fun createFragment(position: Int) = when(position) {
            Xp4SettingsViewModel.IDX_CONF -> Xp4SettingConfFragment()
            else -> WipFragment()
        }
    }
}