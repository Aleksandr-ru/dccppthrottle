...
class Sw2SettingsFragment : DecoderFragment() {
    ...
    companion object {
        fun newInstance() = Sw2SettingsFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tabTitles = resources.getStringArray(R.array.sw2_conf_tabs)
    ...
    private inner class SlidePagerAdapter(fragment: Fragment): FragmentStateAdapter(fragment) {
        override fun getItemCount(): Int = resources.getStringArray(R.array.sw2_conf_tabs).size
